...
public class ProgramBlk01C {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------");
        System.out.print("Enter 1st no?: "); // Asks for 1st number
        numOne = scanOne.nextFloat();

        System.out.println("--------------------------------");
        System.out.print("Enter 2nd no?: "); // Asks for 2nd number
        numTwo = scanOne.nextFloat();

        System.out.println("--------------------------------");
        System.out.print("Enter Symbol(+,-,/,*)?: "); // Asks for operator
        ...
        // We will refactor code into a switch statement
