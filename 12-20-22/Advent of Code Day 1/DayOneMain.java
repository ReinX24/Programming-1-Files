public class DayOneMain {
    ...
    public static void main(String[] args) {
        ...
        // Create 5 variables that will represent each elf and their corresponding
        // calories
        int elfOne = 6000;
        int elfTwo = 4000;
        int elfTree = 11000;
        ...
        // Create an array that will hold the elfs
        int[] elfArr = { elfOne, elfTwo, elfTree, elfFour, elfFive };

        // Create a variable that will hold the elf with the highest calores
        int mostElfCal = elfArr[0]; // will have first element as default value

        // Counter that will be used to identify which elf has the highest calories
        int elfCount = 0;

        // For loop to find the elf with the largest calories
        for (int i = 0; i < elfArr.length; i++) {

            if (mostElfCal < elfArr[i]) {

                mostElfCal = elfArr[i];
                elfCount = i + 1; // current element + 1, this is because elfFour has a position of 3 in index
                // if the current iterated elf has more calories as the last, assign new elf to
                // the most calories
        ...
        // Prints the most calories
        System.out.println("The elf with most calories is elf #" + elfCount + " with " + mostElfCal + " calories.");
